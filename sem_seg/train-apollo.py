...
DIR_PATH_H5 = os.path.join(ROOT_DIR, 'data/apollo_sem_seg_hdf5_data')
...
room_filelist = [line.rstrip() for line in open('data/apollo_sem_seg_hdf5_data/room_filelist.txt')]
